...
ggsave(plot=p,filename = "figures/fig3.png", height = 10, width = 9)
...
Previous work suggests systematic differences in the strength of natural selection acting on synonymous codon usage bias across psychrophiles, mesophiles, and thermophiles.
A prominent hypothesis is that selection for translation efficiency due to the increased
...
tmaritima.phi <- read_csv("ROC/K_1/Thermotoga_maritima/run_1/Parameter_est/gene_expression.txt")
