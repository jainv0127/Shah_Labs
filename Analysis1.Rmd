...
```{r}
tree <- read.tree("Phylogeny/AgashiPhyloFiltered.nwk")
plot(tree)
...
temp.vs.div <- gls(Diversity.tGCN ~ Temperature,data=tree.data,correlation=corBrownian(1,tree.filt))
temp.vs.gc <- gls(Diversity.tGCN ~ GC,data=tree.data,correlation=corBrownian(1,tree.filt))

temp.vs.div.w.gc <- gls(Diversity.tGCN ~ Temperature + GC,data=tree.data,correlation=corBrownian(1,tree.filt))
...
temp.vs.err <- gls(Median.eM ~ Temperature,data=tree.data,correlation=corBrownian(1,tree.filt))
temp.vs.gc <- gls(Median.eM ~ GC,data=tree.data,correlation=corBrownian(1,tree.filt))

temp.vs.err.w.gc <- gls(Median.eM ~ Temperature + GC,data=tree.data,correlation=corBrownian(1,tree.filt))
...
```{r}
temp.vs.total <- gls(Total.tGCN ~ Temperature,data=tree.data,correlation=corBrownian(1,tree.filt))
temp.vs.gc <- gls(Total.tGCN ~ GC,data=tree.data,correlation=corBrownian(1,tree.filt))
temp.vs.total.w.gc <- gls(Total.tGCN ~ Temperature + GC,data=tree.data,correlation=corBrownian(1,tree.filt))
