...
summary(l)
```
Although differences are small, we 
...
tmaritima.phi <- read_csv("ROC/K_3_allUnique/Thermotoga_maritima/run_1/Parameter_est/gene_expression.txt")
...
```
>>>>>>> 231ac359dbad3f7c4a823c9256f5bc0d4d9a7456
